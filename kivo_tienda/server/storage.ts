...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    // Create categories
    const categories = [
      { name: "Electrónicos", description: "Smartphones, laptops, accesorios", icon: "📱" },
      { name: "Ropa", description: "Moda para hombre y mujer", icon: "👕" },
      { name: "Hogar", description: "Decoración y muebles", icon: "🏠" },
      { name: "Abarrotes", description: "Alimentos y productos básicos", icon: "🛒" },
    ];
    ...
    const products = [
      ...
      {
        name: "Chaqueta Denim",
        description: "Chaqueta de mezclilla clásica, perfecta para cualquier ocasión",
        price: "899.00",
      ...
      },
      {
        ...
        description: "Calzado deportivo cómodo y con estilo para el día a día",
        price: "1299.00",
